...
c************************************************************************************
c
c   1) Compilation (linux):  gfortran -march=native -O3 iftci_v6.f -o iftci
...
c   line 7:  value for smearing constant   or a blank line
...
c   line 14: value for non-const rescaling or a blank line
c
...
c 1 is subtracted from nfit below
 ...
 1138 FORMAT(1X,'Fitting flat background [N]o (default) or [Y]es => ',$)
      ...
      WRITE(6,1388)
 1388 FORMAT(1X,'Const. rescale (L) (default), q-dep rescale (S) => ',$)
      read(555,4)dummy
      answer8='S'
      if(dummy.ne.'       ') then
      open(unit=50,file='dummy.d',status='unknown')
...
c*********************************************
      ...
      write(21,*)'# q,I,sigma'
      if(answer8.eq.'S') then
        write(21,*)'# errors rescaled with factor'
      else
        write(21,*)'# errors rescaled with factor: ', beta
      endif
      n=1
      ns=1
      sumsquare=0.0
...
c       qmax for ns'th shannon channel
  ...
  112 continue
      ...
      do 113, i=1,mtotxx
        ...
        chi=betan(n)*betan(n)
        if(answer8.eq.'S') then
          write(21,*)xori(i),y(i),sd2,betan(n)
        else
          write(21,*)xori(i),y(i),sd1,beta
        endif
  113 continue
c*********************************************
