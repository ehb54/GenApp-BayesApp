...
c      sname='st_'//bname
      ...
      hxname='data.d'
      sname='st.d'
      if(answer8.eq.'N') screen='set term gif medium size 500,360'
      if(answer8.eq.'C') screen='set term gif large size 1000,720'
...
c*****************
      ...
      write(88,818)screen
	write(88,*)'set output "fig4.gif"'
	write(88,885)bname,gsname,gxname,bname,gsname,gxname
 885  format(1x,'plot 0 w l 3,''',a,''' w e 1,''',a,''' w e 2 ,''',a,''' 
     -  w e 4,
     -  ''',a,''' w l 1,''',a,''' w l 2 ,''',a,''' 
     -  w l 4')
	write(88,*)'set yrange [*:*]'
